...
public class ZonaFitForma extends JFrame {
    ...
    public ZonaFitForma(ClienteServicio clienteServicio){
        ...
        eliminarButton.addActionListener(e -> eliminiarCliente());
    ...
    private void createUIComponents() {
        ...
        this.tablaModeloClientes = new DefaultTableModel(0,4) {
            @Override // No se permite edicion de celda
            public boolean isCellEditable(int row, int column) {
                return false;
            }
        };
        String[] cabeceros = {"id", "nombre", "pellido", "membresia"};
        this.tablaModeloClientes.setColumnIdentifiers(cabeceros);
        this.clientesTabla = new JTable(tablaModeloClientes);
        // Restringir seleccion multiple
    ...
    private void guardarCliente() {
        ...
        this.clienteServicio.guardarCliente(cliente); // Se inserta el cliente en la base de datos / Se modifica el cliente
    ...
    private void cargarClienteSeleccionado() {
        ...
        if (renglon != -1) { // Significa que no se ha seleccionado ninggun registro
    ...
    private void limpiarFormulario() {
        ...
        // Limpiamos el idCliente seleccionado
        this.idCliente = null;
