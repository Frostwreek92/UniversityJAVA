public class ReglasNombresVariables {
    public static void main(String[] args) {
        ...
        String NombreCompleto = "Juan Carlos 2"; // Correcto, no aplica buenas prácticas
        System.out.println("NombreCompleto = " + NombreCompleto);
        ...
        int totPzs = 10; // Correcta, pero no aplica las buenas practicas
        int totalPiezas = 10; // Correcto, aplica las buenas practicas
        boolean casado = true; // Correcto, aun puede mejorar
        boolean esCasadp = true; // Correcto y aplica buenas practicas
