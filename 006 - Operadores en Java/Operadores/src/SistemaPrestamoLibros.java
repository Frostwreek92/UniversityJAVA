...
public class SistemaPrestamoLibros {
    public static void main(String[] args) {
        ...
        var esElegiblePrestamo = tienesCredencial || distanciaBibliotecaKm <= DISTANCIA_PERMITIDA;
        System.out.println("¿Es elegible para el prestamo de libros?: " + esElegiblePrestamo);
    }
}
